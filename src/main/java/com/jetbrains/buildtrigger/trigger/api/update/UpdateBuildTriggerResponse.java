...
/**
 * Данные ответа на обновление триггера сборок
 *
 * @author Vitaliy Kim
 * @since 20.01.2023
 */
public class UpdateBuildTriggerResponse {
    ...
    @JsonCreator
    private UpdateBuildTriggerResponse(@Nonnull @JsonProperty("id") Long id,
    ...
    /**
     * Создает новый объект билдера для {@link UpdateBuildTriggerResponse}
     */
    @Nonnull
    ...
    /**
     * Билдер для {@link UpdateBuildTriggerResponse}
     */
    public static final class Builder {
         ...
         */
        @Nonnull
        public UpdateBuildTriggerResponse build() {
            return new UpdateBuildTriggerResponse(id, triggerType, repositoryData, branches, nextExecutionTime,
