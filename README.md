...
- Для полноценного CRUD добавить endpoint fundAll, для получения списка триггеров
...
как я это сделать для данных веток - они находятся в таблице branch.
В текстовом JSON-формате храню в целях экономии времени и потому, что в данном бизнес-кейсе я не увидел в этом потребности.
